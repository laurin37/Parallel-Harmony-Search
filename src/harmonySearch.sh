...
#Parallel MPI
#mpirun.actual -np 2 ./Parallel-Harmony-Search/src/mpi.out 1000 10000000 0.9 0.3 0.01 1
#mpirun.actual -np 4 ./Parallel-Harmony-Search/src/mpi.out 1000 10000000 0.9 0.3 0.01 1
#mpirun.actual -np 8 ./Parallel-Harmony-Search/src/mpi.out 1000 10000000 0.9 0.3 0.01 1
