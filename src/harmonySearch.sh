...
#Parallel MPI
#./Parallel-Harmony-Search/src/serial.out 10000 1000000 0.9 0.3 0.01 42
./Parallel-Harmony-Search/src/serial2.out 10000 0.9 0.3 0.01 1000000 5 42

#mpirun.actual -np 1 ./Parallel-Harmony-Search/src/mpi.out 10000 1000000 0.9 0.3 0.01 1
...
#mpirun.actual -np 16 ./Parallel-Harmony-Search/src/mpi.out 10000 1000000 0.9 0.3 0.01 1
