...
#Parallel MPI
./Parallel-Harmony-Search/src/serial.out 1000 0.9 0.3 0.01 1000000 36 42
mpirun.actual -np 1 ./Parallel-Harmony-Search/src/mpi.out 1000 0.9 0.3 0.01 1000000 36 42
mpirun.actual -np 2 ./Parallel-Harmony-Search/src/mpi.out 1000 0.9 0.3 0.01 1000000 36 42
mpirun.actual -np 4 ./Parallel-Harmony-Search/src/mpi.out 1000 0.9 0.3 0.01 1000000 36 42
mpirun.actual -np 8 ./Parallel-Harmony-Search/src/mpi.out 1000 0.9 0.3 0.01 1000000 36 42
mpirun.actual -np 16 ./Parallel-Harmony-Search/src/mpi.out 1000 0.9 0.3 0.01 1000000 36 42
mpirun.actual -np 32 ./Parallel-Harmony-Search/src/mpi.out 1000 0.9 0.3 0.01 1000000 36 42
mpirun.actual -np 64 ./Parallel-Harmony-Search/src/mpi.out 1000 0.9 0.3 0.01 1000000 36 42
